...
#   3. 每日自动（计划任务）：schtasks /Create /SC DAILY /ST 03:00 /TN "QW-Backup" /TR "powershell -ExecutionPolicy Bypass -File F:\My_Projects\Wasteland\qdu-wasteland\backup.ps1" /F
