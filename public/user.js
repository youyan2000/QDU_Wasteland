...
function render(d) {
  ...
  wrap.innerHTML = `
    <div class="u-card">
      ...
      <button id="blockUserBtn" class="me-btn mini" style="margin-top:1rem;display:none"></button>
    </div>
  ...
  if (r.status === 200) {
    ...
    zone.innerHTML = `
      ...
      <div style="display:flex;align-items:center;gap:10px;margin-top:8px">
        <button class="me-btn primary" id="dmSend">发送私信</button>
