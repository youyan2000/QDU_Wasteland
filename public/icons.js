...
window.ICONS = (function () {
  ...
  return {
    ...
    // 眼睛-划掉（密码隐藏）
    'eye-off': (s, c) => svg('<path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z"/><path d="m3 3 18 18"/><circle cx="10.5" cy="10.5" r="2.5"/>', s, c),
    'eye-off': (s, c) => svg('<path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z"/><path d="m3 3 18 18"/><circle cx="10.5" cy="10.5" r="2.5"/>', s, c),
    // 禁止（拉黑）
    ban: (s, c) => svg('<circle cx="12" cy="12" r="10"/><path d="m4.9 4.9 14.2 14.2"/>', s, c),    // 编辑笔
    ban: (s, c) => svg('<circle cx="12" cy="12" r="10"/><path d="m4.9 4.9 14.2 14.2"/>', s, c),
    // 上传
    upload: (s, c) => svg('<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/>', s, c),
    ...
    // 垃圾桶（删除）
    trash: (s, c) => svg('<path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" x2="10" y1="11" y2="17"/><line x1="14" x2="14" y1="11" y2="17"/>', s, c)
  };
})();